...
const InfoIgrejaScreen: React.FC = ({ route, navigation }: any) => {
            ...
            <View style={{ flex: 1, backgroundColor: currentTheme.backgroundColor, padding: 10, }}>
                <View style={{ justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                    <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center' }} onPress={() => navigation.goBack()}>
                        ...
                        <Text style={{ color: currentTheme.buttonColor, fontSize: 18 }}>Igrejas</Text>
                    </TouchableOpacity>
                </View>
                <ScrollView>
                    <View style={{ borderWidth: 1, borderColor: currentTheme.bordercolor, borderRadius: 5, marginTop: 10 }}>
                        <View style={{ padding: 10, borderBottomWidth: 1, borderColor: currentTheme.bordercolor }}>
                            <Text style={{ color: currentTheme.textColor, fontSize: 18 }}>{nome}</Text>
                        </View>
...
export default InfoIgrejaScreen;